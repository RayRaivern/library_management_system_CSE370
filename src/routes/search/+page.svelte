        ...
        <Card.Content class="pt-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                ...
                <div class="space-y-2">
                    ...
                    <Input id="name" name="name" placeholder="e.g. Gatsby" value={data.searchValues.bookName} />
                </div>

                <!-- Author -->
                <div class="space-y-2">
                    <Label for="author">Author</Label>
                    <Input id="author" name="author" placeholder="e.g. F. Scott" value={data.searchValues.author} />
                </div>
